...
/**
 * @see ReflectionUtilsCopiedFromSpringTest do Spring.
 * 
 * Copiei essa classe do spring-test para poder usar as coisas legais de 
 * reflection
 */
public abstract class ReflectionUtilsCopiedFromSpringTest {

	private static final String SETTER_PREFIX = "set";

	private static final String GETTER_PREFIX = "get";

	private static final Log logger = LogFactory.getLog(ReflectionUtilsCopiedFromSpringTest.class);
